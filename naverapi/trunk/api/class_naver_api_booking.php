...
//		$post_data["size"] = 20;
	...
	{
		$url = NAVER_API_URL_REAL."/v3.1/businesses/".$businessId."/biz-items/".$bizItemId."/holiday-schedules";
...
/* 기타 시작 ============================================================================================================================*/
	...
	{
		$url = NAVER_API_URL_REAL."/v3.0/addresses";
	...
	//신규 주소 조회
	public function search_address_new($query)
	{
