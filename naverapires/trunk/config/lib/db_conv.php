...
class mysql2i{
      ...
      public static function mysql_connect($host = '',$username = '',$passwd = '',$db = '',$port = '',$new_link = false,$client_flags = 0){

          $link = mysqli_connect($host,$username,$passwd,$db,$port);
          self::$currObj = $link;
      ...
      */
      ...
      public static function mysql_result($result,$row,$field=null){
          ...
          } else if(  !empty($field) && is_numeric($field) ) {
...
function mysql_connect($host = '',$username = '',$passwd = '',$db = '',$port = '',$new_link = false,$client_flags = 0){

    return mysql2i::mysql_connect($host,$username,$passwd,$db,$port);
