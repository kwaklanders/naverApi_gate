...
/* 업체 시작 ============================================================================================================================*/
	...
	public function search_business($businessId)
	{
		...
		$rtn_data = curl_post(C_NAVER_API_SLOT_URL, $post_data);
...
//		$rtn_data = $post_data;
	...
	//일회성 스케줄 수정
	public function edit_bizItemSchedule_slot_new($businessId, $string_schedule, $block_list)
	{
		$post_data["cmd"] = "edit_bizItemSchedule_slot_new";
		$post_data["businessId"] = $businessId;
		$post_data["scheduleList"] = $string_schedule;
		$post_data["json"] = $block_list;
...
//		$rtn_data = json_decode($rtn_data, true);
	...
	{
		$post_data["cmd"] = "edit_bizItemSchedule_slot_qpos";
		$post_data["businessId"] = $businessId;
		$post_data["bizItemId"] = $bizItemId;
		//주소창에 넣을 스케줄id임.
		$post_data["scheduleId"] = $scheduleId;
